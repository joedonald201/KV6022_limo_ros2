...
For the worskhop tasks, please refer to [wiki pages](https://github.com/kivrakh/KV6022_limo_ros2/wiki)
...
- **Localisation**: 3D position calculation using RGB-D camera and TF transforms
...
### Detection Algorithm
1. **Colour Filtering**: Converts RGB image to HSV colour space
2. **Thresholding**: Isolates pink region (HSV range: 130-180, 40-255, 40-255)
...
5. Publishes marker to '/marker' topic for Rviz visualisation

### Navigation Strategy
- **Waypount-based follower**: Waypoints are generated round the track for robot to follow
...
- **Depth Topic**: '/limo_camera/depth/image'
